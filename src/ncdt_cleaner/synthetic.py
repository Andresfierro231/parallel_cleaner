...
It intentionally supports a few messy-schema options as well so scaling and
ingestion robustness can be discussed without maintaining separate test
fixtures by hand.
'''
...
def generate_synthetic_timeseries(
    ...
    repository's emphasis on raw archival sensor files and scales more
