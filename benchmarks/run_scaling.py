...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=None,
        help=f"Benchmark modes to run. Defaults come from execution.default_modes in the config. {MODE_HELP}",
    )
    parser.add_argument(
        "--mpi-launcher",
        default="mpirun",
        help="MPI launcher to use for replicated/partitioned benchmark runs.",
    )
    ...
    rows = run_scaling_study(
        ...
        modes=args.modes or execution_cfg.get("default_modes"),
